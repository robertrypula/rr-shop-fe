...
export class ViewportFacadeService {
  ...
  public selectGetFurtherNavigationIdAtEveryDevice$: Observable<number> = this.store.pipe(
    select(fromViewportSelectors.selectGetFurtherNavigationIdAtEveryDevice)
  );
