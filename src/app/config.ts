...
export const HEADER_FIXED_DESKTOP_MEDIUM_THRESHOLD = 69;
export const HEADER_FIXED_DESKTOP_LARGE_THRESHOLD = 69;
export const HEADER_FIXED_DESKTOP_EXTRA_LARGE_THRESHOLD = 69;
