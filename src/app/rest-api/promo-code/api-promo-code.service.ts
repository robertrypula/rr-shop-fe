...
import { fromPromoCodeResponse } from './api-promo-code.mappers';
...
export class ApiPromoCodeService {
  ...
  public getPromoCode(promoCodeTextField: string): Observable<PromoCodeStore> {
    return this.http
      ...
      .pipe(
        map((promoCodeResponseDto: PromoCodeResponseDto): PromoCodeStore => fromPromoCodeResponse(promoCodeResponseDto))
      );
  }
}
